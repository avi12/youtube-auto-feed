...
// Hold each survivor at its pre-write screen position via `translate`, re-run every frame so it
// catches whichever node Polymer's async re-stamp currently binds to each video.
