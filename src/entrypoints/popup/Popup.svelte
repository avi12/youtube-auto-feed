...
<main style:--ytaf-motion-scale={isAnimationsEnabled ? "1" : "0"} class="app">
  <header class="app__header">
    <h1 class="app__title">YouTube Auto Feed</h1>
    <p class="app__tagline">Live subscriptions, zero reloads</p>
  </header>
  ...
  <footer class="app__footer">
    <a
      ...
      target="_blank">
      <svg class="app__feedback-icon" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24">
